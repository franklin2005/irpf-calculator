<x-layouts.app
    title="Pagina no encontrada - Calculadora IRPF Espana"
    meta-description="La pagina solicitada no existe o fue movida. Vuelve al inicio de la calculadora IRPF."
...
>
    <main class="irpf-app-bg min-h-screen px-4 py-12 md:px-8">
        <section class="mx-auto w-full max-w-3xl irpf-panel rounded-3xl p-8 text-center md:p-10">
            ...
            <h1 class="irpf-display mt-3 text-5xl text-[var(--irpf-ink)] md:text-6xl">Pagina no encontrada</h1>
