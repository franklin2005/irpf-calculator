<x-layouts.app
    title="Página no encontrada - Calculadora de IRPF España"
    meta-description="La página solicitada no existe o ya no está disponible."
...
>
    <main class="irpf-app-bg min-h-screen px-4 py-12 md:px-8">
        <section class="mx-auto w-full max-w-3xl irpf-panel rounded-3xl p-8 text-center md:p-10">
            ...
            <h1 class="irpf-display mt-3 text-5xl text-[var(--irpf-ink)] md:text-6xl">Página no encontrada</h1>
