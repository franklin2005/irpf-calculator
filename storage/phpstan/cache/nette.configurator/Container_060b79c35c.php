...
class Container_060b79c35c extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_060b79c35c $container)
			{
	...
	public function createServiceContainer(): Container_060b79c35c
	{
		return $this;
	}
